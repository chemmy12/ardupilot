...
//        hal.console->printf("AC_AttitudeControl rate: x=%f, y=%f, z=%f\n", _euler_rate_target.x, _euler_rate_target.y, _euler_rate_target.z);
...
//        hal.console->printf("AC_AttitudeControl out: x=%f, y=%f, z=%f\n", _euler_angle_target.x, _euler_angle_target.y, _euler_angle_target.z);
    }
